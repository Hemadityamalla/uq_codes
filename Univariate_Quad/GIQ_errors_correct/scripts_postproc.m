...
for ii = [1:nquad]
    ...
    %F3
    error.f3{iter} = [(5:5:30)',csvread(strcat('Errors_quad',num2str(ii),'_fn3.dat'))];
    %F4
    error.f4{iter} = [(5:5:30)',csvread(strcat('Errors_quad',num2str(ii),'_fn4.dat'))];
    %F5
    error.f5{iter} = [(5:5:30)',csvread(strcat('Errors_quad',num2str(ii),'_fn5.dat'))];
    iter = iter + 1;
end
