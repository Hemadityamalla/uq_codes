clear;clc;close all;
set(0,'DefaultAxesFontSize',16,'DefaultAxesFontWeight','bold','DefaultLineLineWidth',2,'DefaultLineMarkerSize',25);
...
for i=1:20
   ...
   [x,~]= chebpts(i);%(-cos((pi*((1:i)-1))/(i-1)) + 1)*0.5;
   x = 0.5*(x+1);
   ...
   set(gcf,'Position',[0 0 600 600]); box on;
